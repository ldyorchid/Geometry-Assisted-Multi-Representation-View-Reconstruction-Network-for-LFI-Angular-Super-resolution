...
parser.add_argument("--model_path", type=str, default="./pretrained_model/HCI.pth", help="pretrained model path")
...
parser.add_argument("--data_path", type=str, default="./LFData/test_HCI.h5")
parser.add_argument("--save_img", type=int, default=0, help="save image or not 1/0")
